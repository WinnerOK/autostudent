from autostudent.tg_bot.callbacks.language_level import language_level_callback
from autostudent.tg_bot.callbacks.save_discovered_word import save_discovered_word_callback
from autostudent.tg_bot.callbacks.tinder_session import (
    finish_tinder_session,
    process_tinder_session_choice,
)
from autostudent.tg_bot.callbacks.training import (
