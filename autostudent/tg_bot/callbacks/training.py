...
import autostudent.repository.training as training_repo

from autostudent import definition
...
from autostudent.tg_bot.markups import (
    training_iteration_end_markup,
)
from autostudent.tg_bot.utils.training import (
    SortOrder,
